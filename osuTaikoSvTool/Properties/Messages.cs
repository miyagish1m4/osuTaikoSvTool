namespace osuTaikoSvTool.Properties
{
    class Messages
    {
        ...
        public static Dictionary<string, string> DialogMessages = new()
        {
            ...
            { "E-006", "Timingのフォーマットが間違えています。" },
            { "E-007", "Timingの始点が終点の値を上回っています。" },
            { "E-008", "SVの値を指定してください。" },
            { "E-009", "SVのフォーマットが間違えています。" },
            { "E-010", "SVの値は正の数(0除く)を指定してください。" },
            { "E-011", "Volumeの値を指定してください。" },
            { "E-012", "Volumeのフォーマットが間違えています。" },
            { "E-013", "Volumeの値は正の整数(0除く)を指定してください。" },
            { "E-014", "オフセットのフォーマットが間違えています。" },
            { "E-015", "グラデーションの型を指定してください。" },
            { "E-016", "ビートスナップ間隔を指定してください。" },
            { "E-017", "ビートスナップ間隔は正の整数(0除く)を指定してください。" }
        };
        // ログメッセージ
